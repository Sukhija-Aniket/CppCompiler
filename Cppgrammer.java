/* Generated By:JavaCC: Do not edit this line. Cppgrammer.java */
import syntaxtree.*;
import java.util.Vector;


public class Cppgrammer implements CppgrammerConstants {
  ...
  static final public Statement Statement() throws ParseException {
   NodeChoice n0;
   ModuleDeclaration n1;
   ImportStatement n2;
   ExportImportStatement n3;
   ModuleStatement n4;
   IncludeStatement n5;
   OtherStatement n6;
    if (jj_2_1(2147483647)) {
      n1 = ModuleDeclaration();
        n0 = new NodeChoice(n1, 0);
    } else if (jj_2_2(2147483647)) {
      n2 = ImportStatement();
        n0 = new NodeChoice(n2, 1);
    } else if (jj_2_3(2147483647)) {
      n3 = ExportImportStatement();
  ...
  static final public ModuleDeclaration ModuleDeclaration() throws ParseException {
   NodeToken n0;
   Token n1;
   NodeToken n2;
   Token n3;
   ...
   Token n6;
    ...
    n6 = jj_consume_token(SEMICOLON);
     ...
     {if (true) return new ModuleDeclaration(n0,n2,n4,n5);}
    throw new Error("Missing return statement in function");
  }
  ...
  static final public ExportImportStatement ExportImportStatement() throws ParseException {
   NodeToken n0;
   Token n1;
   NodeToken n2;
   Token n3;
   ...
   Token n6;
    ...
    n6 = jj_consume_token(SEMICOLON);
            n5 = JTBToolkit.makeNodeToken(n6);
     {if (true) return new ExportImportStatement(n0,n2,n4,n5);}
    throw new Error("Missing return statement in function");
  }

  static final public ModuleStatement ModuleStatement() throws ParseException {
   NodeToken n0;
   Token n1;
   DotIdentifier n2;
   NodeToken n3;
   Token n4;
    ...
    n4 = jj_consume_token(SEMICOLON);
            n3 = JTBToolkit.makeNodeToken(n4);
     {if (true) return new ModuleStatement(n0,n2,n3);}
    throw new Error("Missing return statement in function");
  }

  static final public IncludeStatement IncludeStatement() throws ParseException {
   NodeToken n0;
   Token n1;
   NodeToken n2;
   Token n3;
   ...
   Token n6;
   Include n7;
    n1 = jj_consume_token(HASH);
            n0 = JTBToolkit.makeNodeToken(n1);
    n3 = jj_consume_token(INCLUDE);
                  n2 = JTBToolkit.makeNodeToken(n3);
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case STRING_LITERAL:
    ...
    default:
     ...
     {if (true) return new IncludeStatement(n0,n2,n4);}
    throw new Error("Missing return statement in function");
  }
  ...
  static final public Include Include() throws ParseException {
   ...
   Token n4;
    ...
    n4 = jj_consume_token(GREATER);
            n3 = JTBToolkit.makeNodeToken(n4);
     {if (true) return new Include(n0,n2,n3);}
    throw new Error("Missing return statement in function");
  }
  ...
  static final public OtherStatement OtherStatement() throws ParseException {
   ...
   Token n110;
    ...
    case AT:
      ...
      break;
    case HASH:
      n16 = jj_consume_token(HASH);
                   n15 = JTBToolkit.makeNodeToken(n16);
        n0 = new NodeChoice(n15, 7);
      break;
    case DEFINE:
      n18 = jj_consume_token(DEFINE);
  ...
  static public CppgrammerTokenManager token_source;
  ...
  static {
   ...
   private static void jj_la1_init_2() {
      jj_la1_2 = new int[] {0x1f,0x1f,0x8,0x10,0x1f,};
   }
  ...
  public Cppgrammer(java.io.InputStream stream) {
     this(stream, null);
  }
  /** Constructor with InputStream and supplied encoding */
  public Cppgrammer(java.io.InputStream stream, String encoding) {
    ...
    token_source = new CppgrammerTokenManager(jj_input_stream);
    token = new Token();
    jj_ntk = -1;
    jj_gen = 0;
  ...
  /** Constructor. */
  public Cppgrammer(java.io.Reader stream) {
    if (jj_initialized_once) {
      System.out.println("ERROR: Second call to constructor of static parser. ");
      System.out.println("       You must either use ReInit() or set the JavaCC option STATIC to false");
      System.out.println("       during parser generation.");
  ...
  public Cppgrammer(CppgrammerTokenManager tm) {
    if (jj_initialized_once) {
      System.out.println("ERROR: Second call to constructor of static parser. ");
      System.out.println("       You must either use ReInit() or set the JavaCC option STATIC to false");
      System.out.println("       during parser generation.");
  ...
  /** Reinitialise. */
  public void ReInit(CppgrammerTokenManager tm) {
    token_source = tm;
    token = new Token();
    jj_ntk = -1;
    jj_gen = 0;
